...
!angular.$$csp() && angular.element(document).find('head').prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide{display:none !important;}ng\\:form{display:block;}.ng-animate-block-transitions{transition:0s all!important;-webkit-transition:0s all!important;}</style>');(function (window, angular, undefined) {
  ...
  removeNoscriptTags = function (node) {
    node.innerHTML = node.innerHTML.replace(/<noscript[\S\s]*?<\/noscript>/gi, '');
    return node;
  };
  ...
  extractTitleAndBody = function (doc) {
    ...
    return [
      title != null ? title.textContent : void 0,
      removeNoscriptTags(doc.body),
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      var drop = '<div class=\'btn-group bootstrap-select' + multiple + '\'>' + '<button type=\'button\' class=\'btn dropdown-toggle\' data-toggle=\'dropdown\'>' + '<div class=\'filter-option pull-left\'></div>&nbsp;' + '<div class=\'caret\'></div>' + '</button>' + '<div class=\'dropdown-menu open\'>' + header + searchbox + '<ul class=\'dropdown-menu inner\' role=\'menu\'>' + '</ul>' + '</div>' + '</div>';
      return $(drop);
    },
    createView: function () {
    ...
    createA: function (text, classes, inline) {
      return '<a tabindex="0" class="' + classes + '" style="' + inline + '">' + text + '<i class="glyphicon glyphicon-ok icon-ok check-mark"></i>' + '</a>';
    },
    render: function () {
      var that = this;
  ...
  $(document).data('keycount', 0).on('keydown', '[data-toggle=dropdown], [role=menu]', Selectpicker.prototype.keydown);
}(window.jQuery);if (!jQuery) {
...
+function (a) {
  ...
  ctrls.controller('MyController', [
    ...
    function ($scope, Services) {
      ...
      $scope.save_link = function () {
        ...
        linkParams = {
          name: $scope.linkName,
          categoryID: $scope.linkCategoryID,
          url: $scope.linkUrl
        };
        $scope.linkName = '';
        $scope.linkCategoryID = 1;
        $scope.linkUrl = '';
        return Services.create_link(linkParams).then(function (resp) {
          console.log(resp);
          return $scope.links = resp;
        });
      };
      $scope.get_links = function () {
        return Services.fetch_links().then(function (resp) {
          console.log(resp);
          return $scope.links = resp;
        });
      };
      $scope.get_categories = function () {
        return Services.fetch_categories().then(function (resp) {
          console.log(resp);
          return $scope.categories = resp;
        });
      };
      $scope.getCategoryNameById = function (category_id) {
      ...
      $scope.initialize();
      return $scope.toggle_new_link_modal = function () {
  ...
  angular.module('Mytree.services', ['ngResource']).factory('Services', [
    '$http',
    '$q',
    function ($http, $q) {
      return {
        create_category: function (categoryParams) {
          return $http.post('/category', categoryParams).then(function (resp) {
            console.log('Services.create_category response', resp.data);
            return resp.data;
          });
        },
        create_link: function (linkParams) {
          return $http.post('/link', linkParams).then(function (resp) {
            console.log('Services.create_link response', resp.data);
            return resp.data;
          });
        },
        fetch_links: function () {
          return $http.get('/link').then(function (resp) {
            console.log('Services.fetch_links response', resp.data);
            return resp.data;
          });
        },
        fetch_categories: function () {
          return $http.get('/category').then(function (resp) {
  ...
  window.JST['views/new_category'] = function (context) {
    return function () {
      var $o;
      $o = [];
      $o.push('<div class=\'fade modal\' id=\'newCategory\' aria-hidden=\'true\' aria-labelledby=\'myModalLabel\' role=\'dialog\' tabindex=\'-1\'>\n  <div class=\'modal-dialog\'>\n    <div class=\'modal-content\'>\n      <div class=\'modal-header\'>\n        <button class=\'close\' aria-hidden=\'true\' data-dismiss=\'modal\' type=\'button\'>&times;</button>\n        <h4 class=\'modal-title\' id=\'myModalLabel\'>New Category</h4>\n      </div>\n      <div class=\'modal-body\'>\n        <form class=\'form-horizontal\' role=\'form\'>\n          <div class=\'form-group\'>\n            <label class=\'col-sm-3 control-label\' for=\'category-name-form\'>Name</label>\n            <div class=\'col-sm-7\'>\n              <input class=\'form-control1\' id=\'category-name-form\' type=\'string\' placeholder=\'Enter name\' ng-model=\'categoryName\'>\n            </div>\n          </div>\n          <div class=\'form-group\'>\n            <label class=\'col-sm-3 control-label\' for=\'category-parent-form\'>Parent</label>\n            <div class=\'col-sm-7\'>\n              <select class=\'form-control1\' id=\'category-parent-form\' ng-model=\'categoryParentID\' ng-options=\'category.id as category.name for category in categories\'></select>\n            </div>\n          </div>\n        </form>\n      </div>\n      <div class=\'modal-footer\'>\n        <button class=\'btn btn-default\' data-dismiss=\'modal\' type=\'button\'>Close</button>\n        <button class=\'btn btn-primary\' type=\'button\' ng-click=\'save_category()\'>Save changes</button>\n      </div>\n    </div>\n  </div>\n</div>');
  ...
  window.JST['views/new_link'] = function (context) {
    return function () {
      var $o;
      $o = [];
      $o.push('<div class=\'fade modal\' id=\'newLink\' aria-hidden=\'true\' aria-labelledby=\'myModalLabel\' role=\'dialog\' tabindex=\'-1\'>\n  <div class=\'modal-dialog\'>\n    <div class=\'modal-content\'>\n      <div class=\'modal-header\'>\n        <button class=\'close\' aria-hidden=\'true\' data-dismiss=\'modal\' type=\'button\'>&times;</button>\n        <h4 class=\'modal-title\' id=\'myModalLabel\'>New Link</h4>\n      </div>\n      <div class=\'modal-body\'>\n        <form class=\'form-horizontal\' role=\'form\'>\n          <div class=\'form-group\'>\n            <label class=\'col-sm-3 control-label\' for=\'link-name-form\'>Name</label>\n            <div class=\'col-sm-7\'>\n              <input class=\'form-control1\' id=\'link-name-form\' type=\'string\' placeholder=\'Enter name\' ng-model=\'linkName\'>\n            </div>\n          </div>\n          <div class=\'form-group\'>\n            <label class=\'col-sm-3 control-label\' for=\'link-url-form\'>Url</label>\n            <div class=\'col-sm-7\'>\n              <input class=\'form-control1\' id=\'link-url-form\' type=\'string\' placeholder=\'Enter url\' ng-model=\'linkUrl\'>\n            </div>\n          </div>\n          <div class=\'form-group\'>\n            <label class=\'col-sm-3 control-label\' for=\'link-category-form\'>Category</label>\n            <div class=\'col-sm-8\'>\n              <select class=\'form-control1\' id=\'category-parent-form\' ng-model=\'linkCategoryID\' ng-options=\'category.id as category.name for category in categories\' style=\'display: inline-block;\'>\n              </select>\n              <button class=\'btn btn-primary btn-sm\' ng-click=\'toggle_new_link_modal()\'>+</button>\n            </div>\n          </div>\n        </form>\n      </div>\n      <div class=\'modal-footer\'>\n        <button class=\'btn btn-default\' data-dismiss=\'modal\' type=\'button\'>Close</button>\n        <button class=\'btn btn-primary\' type=\'button\' data-dismiss=\'modal\' ng-click=\'save_link()\'>Save changes</button>\n      </div>\n    </div>\n  </div>\n</div>');
      return $o.join('\n').replace(/\s(?:id|class)=(['"])(\1)/gm, '');
    }.call(window.HAML.context(context));
  };
}.call(this));(function () {
  ...
  window.JST['views/select_categories'] = function (context) {
    return function () {
      var $o;
      $o = [];
      return $o.join('\n');
  ...
  window.JST['views/show_all'] = function (context) {
    return function () {
      var $c, $o;
      $c = window.HAML.cleanValue;
      $o = [];
      $o.push('<h1>My Tree</h1>\n<button class=\'btn btn-primary btn-sm\' data-target=\'#newLink\' data-toggle=\'modal\'>New Link\n  <i class=\'fa fa-download\'></i>\n</button>\n<button class=\'btn btn-primary btn-sm\' data-target=\'#newCategory\' data-toggle=\'modal\'>New Category\n  <i class=\'fa fa-download\'></i>\n</button>');
      $o.push('' + $c(JST['views/new_category']()));
      $o.push('' + $c(JST['views/new_link']()));
      $o.push('<br>\n<br>\n<div class=\'row\'>\n  <div class=\'col-md-12\'>\n    <table class=\'table\'>\n      <thead class=\'capitalize\'>\n        <tr ng-show=\'links\'>\n          <th></th>\n          <th class=\'panel_topic text-primary\' ng-click="predicate = \'category_id\'; reverse=!reverse">\n            category\n          </th>\n          <th class=\'panel_topic text-primary\'>\n            name\n          </th>\n        </tr>\n      </thead>\n      <tbody>\n        <tr ng-repeat=\'link in links | orderBy:predicate:reverse\'>\n          <td>\n            <button class=\'btn btn-primary btn-sm\' ng-click=\'remove_link(link)\'>\n              <i class=\'fa fa-trash-o\'></i>\n            </button>\n          </td>\n          <td class=\'panel_topic\'>\n            {{getCategoryNameById(link.category_id)}}\n          </td>\n          <td class=\'panel_topic\'>\n            <a target=\'_blank\' href=\'{{link.url}}\'>\n              {{link.link_name}}\n            </a>\n          </td>\n        </tr>\n      </tbody>\n    </table>\n  </div>\n</div>');
